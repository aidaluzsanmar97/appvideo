(function(){
  ...
  angular.module('app')
    ...
    .controller('financialController', ['$scope', '$window', '$http', '$log', 'Objetives', function ($scope, $window, $http, $log, Objetives) {
      ...
      Objetives.getByPerspectives({ruc: ruc, perspective: 'Finanzas'})
        .then( function(res){
