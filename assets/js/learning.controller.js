(function(){
  ...
  angular.module('app')
    ...
    .controller('learningController', ['$scope', '$window', '$http', '$log', 'Objetives', function ($scope, $window, $http, $log, Objetives) {
      ...
      Objetives.getByPerspectives({ruc: ruc, perspective: 'Aprendizaje'})
        .then( function(res){
      ...
      $scope.newObjetive = function(objetive){
        objetive.perspective = 'Aprendizaje'
