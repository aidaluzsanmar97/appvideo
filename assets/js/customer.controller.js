(function(){
  ...
  angular.module('app')
    ...
    .controller('customerController', ['$scope', '$window', '$http', '$log', 'Objetives', function ($scope, $window, $http, $log, Objetives) {
      ...
      Objetives.getByPerspectives({ruc: ruc, perspective: 'Clientes'})
        .then( function(res){
